...
import { extractPerplexityWeb2ApiText } from "../translator/helpers/perplexityWeb2ApiHelper.ts";
...
`;
          ...
          if (
            ...
            const currentText =
              typeof state.perplexityRawText === "string" ? state.perplexityRawText : "";
            const nextText = extractPerplexityWeb2ApiText(parsed, currentText);
            if (typeof nextText === "string" && nextText.length > currentText.length) {
              ...
              state.perplexityRawText = nextText;
            }
          }
