  ...
  try {
    ...
    const connection: any = await createProviderConnection({
      ...
      providerSpecificData: buildGeminiWebSessionProviderData(null, {
        ...
        routePrefix: validation.routePrefix,
        authUser: validation.authUser,
        modelHeaderTemplate: validation.modelHeaderTemplate,
        streamQueryParams: validation.streamQueryParams,
        streamRequestTemplate: validation.streamRequestTemplate,
        importedAt: now,
        validatedAt: now,
        refreshedAt: now,
