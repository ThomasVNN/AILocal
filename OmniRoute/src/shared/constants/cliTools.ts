...
export const CLI_TOOLS = {
  ...
  antigravity: {
    ...
    color: "#4285F4",
    description: "Google Antigravity IDE via OmniRoute direct routing",
    docsUrl: "/docs?section=cli-tools&tool=antigravity",
    configType: "guide",
    guideSteps: [
      {
        step: 1,
        title: "Open Antigravity Provider Settings",
        desc: "Select an OpenAI-compatible or custom provider.",
      },
      ...
      { step: 4, title: "Model", type: "modelSelector" },
      {
        step: 5,
        title: "Save Provider",
        desc: "Use this provider for chat and agent requests.",
      },
    ],
    codeBlock: {
      language: "json",
...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  kiro: {
    ...
    icon: "psychology_alt",
    color: "#FF6B35",
    description: "Amazon Kiro — AI-powered IDE via direct routing",
